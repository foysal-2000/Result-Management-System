...
<body>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('Backend.result.stored')}}" method="post"> 
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type='text' name='department' value="{{$enrollments->department}}" class='form-control' readonly>
                        </div>
                        <div class="col-md-3">
                            <label for="program" class="form-label"><b>Program</b></label>
                            <input type='text' name='program' value="{{$enrollments->program}}" class='form-control' readonly>
                        </div>

                        <div class="col-md-4">
                            <label for="semester" class='form-label'>Semster</label>
                            <input type='text' name='semster' value="{{$enrollments->semster}}" class='form-control' readonly>
                        </div>
                        <div class="col-md-4">
                            <label for='batch' class='form-label'><b>Semster Number</b></label>
                            <input type='text' name='semster_no' value="{{$enrollments->semster_no}}" class='form-control' readonly>
                        </div>
                        <div class="col-md-4">
                            <label for="year" class='form-label'><b>Year</b></label>
                            <input type='text' name='year' value="{{$enrollments->year}}" class='form-control' readonly>
                        </div>
                    </div>
            </div>
        </div>
